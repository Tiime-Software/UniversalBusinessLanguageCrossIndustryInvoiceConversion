...
class UBLToCIIEN16931Invoice
{
    ...
    private static function getApplicableHeaderTradeAgreement(UniversalBusinessLanguage $invoice): ApplicableHeaderTradeAgreement
    {
        return (new ApplicableHeaderTradeAgreement(
            ...
            ->setSpecifiedProcuringProject(
                null === $invoice->getProjectReference() ? null :
                new SpecifiedProcuringProject(
                    new ProjectReference($invoice->getProjectReference()->getIdentifier())
                )
            ) // BT-11
    ...
    {
        return array_map(
            static fn (InvoiceLine $line) => new IncludedSupplyChainTradeLineItem(
                ...
                specifiedLineTradeDelivery: new SpecifiedLineTradeDelivery(
                    new BilledQuantity(
                        quantity: $line->getInvoicedQuantity()->getQuantity()->getValue(), // BT-129
                        unitCode: $line->getInvoicedQuantity()->getUnitCode() // BT-130
                    )
                ), // BT-129-00.
     ...
     * BG-31.
     */
    private static function getSpecifiedTradeProduct(InvoiceLine $line): SpecifiedTradeProduct
    {
     ...
     * BG-29.
     */
    private static function getSpecifiedLineTradeAgreement(InvoiceLine $line): SpecifiedLineTradeAgreement
    {
     ...
     * BG-30-00.
     */
    private static function getSpecifiedLineTradeSettlement(InvoiceLine $line): SpecifiedLineTradeSettlement
    {
